...
# Jar Path
spark_kafka = "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/spark-sql-kafka-0-10_2.12-3.1.2.jar,"
commons_pool = "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/commons-pool2-2.8.0.jar,"
spark_token = "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/spark-token-provider-kafka-0-10_2.12-3.1.2.jar"
spark_clients = "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/kafka-clients-2.6.0.jar,"
...
def predict(record):
    try:
        ...
        print(
            f"Logits: {logits}, Probabilities: {probabilities}, Prediction: {pred_label_custom_threshold}")  # Debugging line
...
spark = SparkSession.builder \
    ...
    .config('spark.jars',
            "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/spark-sql-kafka-0-10_2.12-3.1.2.jar,"
            "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/commons-pool2-2.8.0.jar,"
            "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/spark-token-provider-kafka-0-10_2.12-3.1.2.jar,"
            "D:/UIT/BigData/Data-Real-Time-Engineer-VOZ/jar/kafka-clients-2.6.0.jar"
        )\
    .getOrCreate()
